...
- **When (UTC):** 2026-06-26T13:04:14Z → 2026-06-26T13:04:14Z (0.0 h)
...
|---|---:|---:|
| `distance_from_shore` | 9790.277 | +0.161 |
| `distance_from_port` | 2215.133 | -0.108 |
| `hour_cos` | -0.961 | -0.033 |
| `speed` | 0.000 | +0.030 |
...
- **Integrity (SHA-256 of canonical facts):** `6ce62e9181cdf0ead39551a5c80374547ab3deafb766557cdf7b5df34304fe9d`
