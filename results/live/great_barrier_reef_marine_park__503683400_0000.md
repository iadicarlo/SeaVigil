...
- **When (UTC):** 2026-06-26T20:27:39Z → 2026-06-26T20:27:39Z (0.0 h)
...
|---|---:|---:|
| `distance_from_shore` | 6591.895 | +0.170 |
| `distance_from_port` | 1144.358 | -0.115 |
| `speed` | 0.000 | +0.040 |
| `speed_roll_std` | 0.000 | -0.036 |
| `hour_cos` | 0.598 | +0.021 |
...
- **Integrity (SHA-256 of canonical facts):** `e5be090663382e354ff9a50a0fc15fac832459a8678ebeed3f669023bc32616d`
